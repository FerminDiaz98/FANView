...
#     Timer(1, open_browser).start()  # Retrasa la apertura del navegador hasta que el servidor esté listo
#     app.run(debug=False, use_reloader=False)  # Desactivar la recarga automática y la apertura automática
